...
res = requests.delete (full_path0, auth=HTTPBasicAuth(username, password), verify=False, headers = headers)
print (res)
res = requests.delete (full_path1, auth=HTTPBasicAuth(username, password), verify=False, headers = headers)
print (res)
...
WANKIM-M-L2HC:7-6-asa wansookim$ python3 7-6-c-acls-delete.py 
...
https://192.168.30.232/api/objects/extendedacls/ACL1/aces/918766196
/Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/site-packages/urllib3/connectionpool.py:857: InsecureRequestWarning: Unverified HTTPS request is being made. Adding certificate verification is strongly advised. See: https://urllib3.readthedocs.io/en/latest/advanced-usage.html#ssl-warnings
  InsecureRequestWarning)
<Response [204]>
/Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/site-packages/urllib3/connectionpool.py:857: InsecureRequestWarning: Unverified HTTPS request is being made. Adding certificate verification is strongly advised. See: https://urllib3.readthedocs.io/en/latest/advanced-usage.html#ssl-warnings
